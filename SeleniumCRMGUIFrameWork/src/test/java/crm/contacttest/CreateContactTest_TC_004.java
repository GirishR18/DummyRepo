...
public class CreateContactTest_TC_004 {
	...
	public void createContactTest() throws Throwable {
		...
		String lastName = wb.getSheet("Contacts").getRow(1).getCell(2).toString() + randomInt;
		...
		if (headerText.contains(lastName)) {
			System.out.println(lastName+" Conatct Is  Created ==>PASS----");
		} else {
			System.out.println(lastName +" Conatct Is not Created ==> FAIL---");
		}
		
		String actualLastName = driver.findElement(By.id("dtlview_Last Name")).getText();
		if (actualLastName.equals(lastName)) {
			System.out.println(lastName +" is ==> PASS");
		} else {
