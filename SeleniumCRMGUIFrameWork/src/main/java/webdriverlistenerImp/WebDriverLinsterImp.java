...
public class WebDriverLinsterImp implements WebDriverListener {
	...
	public void beforeGet(WebDriver driver, String url) {
		System.out.println("I am getting the url");
	...
	public void afterGet(WebDriver driver, String url) {
		// TODO Auto-generated method stub
		System.out.println("I am got the url");
	...
	@Override
	public void beforeScriptTimeout(Timeouts timeouts, Duration duration) {
		// TODO Auto-generated method stub
		WebDriverListener.super.beforeScriptTimeout(timeouts, duration);
	}

	@Override
	public void afterScriptTimeout(Timeouts timeouts, Duration duration) {
		// TODO Auto-generated method stub
	...
	public void beforeClick(WebElement element) {
		System.out.println("➡️ beforeClick on element: " + element);
	}

	@Override
	public void afterClick(WebElement element) {
		System.out.println("✅ afterClick on element: " + element);
	}

	@Override
	public void onError(Object target, Method method, Object[] args, InvocationTargetException e) {
		System.out.println("❌ Error during method: " + method.getName());
		e.getCause().printStackTrace();

		try {
			WebDriver driver = (WebDriver) args[0]; // target can also be WebDriver sometimes
			takeScreenshot(driver, method.getName());
		} catch (Exception ex) {
			System.out.println("⚠️ Could not take screenshot: " + ex.getMessage());
		}
	}
	...
	public void takeScreenshot(WebDriver driver, String methodName) {
		try {
			...
			Files.copy(src.toPath(), Paths.get("./errorShots/" + methodName + "_" + timeStamp + ".png"));
